...
class Subcat_model extends CI_Model {
  ...
  function get_data(){
            ...
            $q = $this->db->get('wp_app_subcategory');
  ...
  function add_data($data)
            {
              ...
              $this->db->insert('wp_app_subcategory',$data);
              return;
...
function update_data($data)
            {
              ...
              $q = $this->db->where('sub_cat_id',$this->uri->segment(3));
              $this->db->update('wp_app_subcategory',$data);
...
function del_data()
            {
              ...
              $this->db->delete('wp_app_subcategory');
